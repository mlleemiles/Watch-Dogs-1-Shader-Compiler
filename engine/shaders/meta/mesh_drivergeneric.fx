...
#ifndef FAMILY_MESH_DRIVERGENERIC
	#define FAMILY_MESH_DRIVERGENERIC
#endif

#include "../VertexDeclaration.inc.fx"

// after checking all permutations, this is not used/defined for mesh_drivergeneric
...
// Dynamic decals
    ...
    float SEMANTIC_VAR(decalViewDist);
#endif
